  ...
  return (
    <div style={{ padding: "24px 0" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
        ...
        {isDesigner && (
          <button onClick={() => void 0 /* Canva integration disabled */} style={{
        ...
        <div style={{ background: "white", border: "1px solid var(--border)", borderRadius: 4, display: "flex", flexDirection: "column", overflow: "hidden" }}>
          <div style={{ padding: "12px 16px", borderBottom: "1px solid var(--border)", flexShrink: 0 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", color: "#9CA3AF" }}>
                Thread
                {req.designerName && <span style={{ marginLeft: 8, color: "var(--navy)", fontWeight: 600 }}>— {req.designerName}</span>}
              </div>
              {slaPaused && (
                <div style={{ display: "flex", alignItems: "center", gap: 5, background: "#ECFEFF", border: "1px solid #A5F3FC", borderRadius: 3, padding: "3px 10px" }}>
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "12px 16px", display: "flex", flexDirection: "column", gap: 10 }}>
            {chatMessages.length === 0 && (
              <div style={{ textAlign: "center", color: "#D1C9BC", fontSize: 12, marginTop: 40 }}>No messages yet</div>
            )}
  ...
  return (
    ...
    >
      ...
      <td style={{ padding: "8px 12px" }}>
        <button
          onClick={e => { e.stopPropagation(); void 0 /* Canva integration disabled */; }}
          style={{
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
          ...
          <tbody>
            {filteredRequests.length === 0 ? (
              <tr><td colSpan={8} style={{ padding: "32px 16px", textAlign: "center", color: "#9CA3AF", fontSize: 12 }}>No results match current filters</td></tr>
...
export default function MarketingIntakeApp() {
  ...
  function navigate(v) {
    ...
    if (v === "requester" || v === "designer" || v === "executive") {
      setDashboardRole(v);
    }
  }

  const ROLE_LABELS = { requester: "Agent", designer: "Designer", executive: "Executive" };
    ...
    <div style={{
          ...
          <div style={{ position: "relative", marginBottom: 8 }}>
            ...
            {rolePickerOpen && (
              <div style={{
                ...
                {[["requester","Yong Choi","Agent","YC"],["designer","Lex Baum","Designer","LH"],["executive","David Kim","Executive","DK"]].map(([v, name, role, initials]) => (
      ...
      <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ background: "white", borderBottom: "1px solid var(--border)", padding: "0 20px", height: 46, display: "flex", alignItems: "center", gap: 16, flexShrink: 0 }}>
          ...
          {/* Date — compact right */}
          <div style={{ fontSize: 10, color: "#C4B99A", letterSpacing: "0.05em", flexShrink: 0, whiteSpace: "nowrap" }}>
